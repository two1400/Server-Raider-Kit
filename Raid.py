...
print(Fore.YELLOW + "I am not responsible for any actions.\n")
...
async def on_ready():
    ...
    print(Fore.GREEN + f"[BOT] LOGGED IN AS: {client.user}")
...
async def on_message(message):
    ...
    if message.content == trigger:
        ...
        print(Fore.GREEN + f"[BOT] PROVIDE SERVER: {message.guild.name}")
        print(Style.RESET_ALL)
